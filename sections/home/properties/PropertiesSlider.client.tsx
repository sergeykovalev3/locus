...
export default function PropertiesSlider({
  ...
  const { navigation, prevButtonProps, nextButtonProps } = useSwiperCustomNav("properties");
  ...
  return (
    <div>
      ...
      <div className="flex justify-between md:justify-end items-center md:items-end gap-1 mt-[30px] md:mt-[40px] xl:mt-[50px] pt-[16px] md:pt-[20px] border-t border-grey15">
